...
class SettingController extends Controller
{
     ...
     {
          $this->middleware('permission:setting-view|setting-create|setting-update|setting-delete', ['only' => ['index']]);
     ...
     public function index(Request $request)
     {
          ...
          return view('admin.settings.index',$arr);
     }
     ...
     public function update(Request $request,$id)
     {
          ...
          if($request->hasfile('light_logo'))
          {
               ...
               $setting=Setting::where('key','light_logo')->first();
          ...
          if($request->hasfile('dark_logo'))
          {
               ...
               $setting=Setting::where('key','dark_logo')->first();
               $old_logo=$setting->value;
               FileManager::deleteFile($old_logo); 

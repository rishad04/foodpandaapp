    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                    ...
                    <form id="find-account-form" class="space-y-4">
                        <input type="text" id="email_or_phone" name="email_or_phone" placeholder="Enter your email or phone" required
                            ...
                            <div class="text-center">
                                <button type="submit" class="site-btn">Find Account</button>
                            </div>
                    </form>
                </div>
                ...
                <a href="{{route('/')}}" id="back-to-home-link" class="block text-center text-blue-600 hover:underline mt-6">Back to Home</a>

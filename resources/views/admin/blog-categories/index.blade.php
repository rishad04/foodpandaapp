                                    ...
                                    <td>
                                        <div class="form-check form-switch form-switch-md">
                                            <input type="checkbox" name="is_active" value="{{ $row->id }}"
                                                onclick="toggleSwitchStatus(this,'blog_categories');"
                                        ...
                                        <ul class="trk-action__list">
                                            <li class="trk-action">
                                                <a class="trk-action__item trk-action__item--success"
                                                    href="{{ route('admin.blog-categories.show', $row->id) }}">
                                            ...
                                            @can('blog-category-update')
                                                <li class="trk-action">
                                                    <a class="trk-action__item trk-action__item--warning"
                                                        href="{{ route('admin.blog-categories.edit', $row->id) }}">
                                            ...
                                            @can('blog-category-delete')
                                                <li class="trk-action">
                                                    <a onclick="deleteCrudItem(`{{ route('admin.blog-categories.destroy', $row->id) }}`)"

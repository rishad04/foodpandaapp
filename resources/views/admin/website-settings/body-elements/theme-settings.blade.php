    ...
    <div class="col-12">
        ...
        <div class="trk-card__wrapper">
            ...
            <div class="trk-card__body">
                <form class="form" action="{{ route('admin.website-theme.settings.update') }}" method="post">
                @csrf
                @method('PUT')
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            id="website-sidebar-light" value="light" @if(isset($data['sidebar_theme']) && $data['sidebar_theme']=='light') checked @endif>
                            <label class="form-check-label" for="website-sidebar-light">Light</label>
                        </div>
    
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sidebar_theme"
                            id="website-sidebar-dark" value="dark" @if(isset($data['sidebar_theme']) && $data['sidebar_theme']=='dark') checked @endif>
                            <label class="form-check-label" for="website-sidebar-dark">Dark</label>
                        </div>
                        </div>
                    </div>
                    <div class="col-12">

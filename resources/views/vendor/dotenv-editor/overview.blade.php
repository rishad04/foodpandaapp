          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label class="form-label" for="editvalue">{!! trans('dotenv-editor::views.overview_edit_modal_value') !!}</label>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form @submit.prevent="addNew()">
            <div class="form-group">
              <label class="form-label" for="newkey">{!! trans('dotenv-editor::views.addnew_label_key') !!}</label>
              <input type="text" name="newkey" id="newkey" v-model="newEntry.key" class="form-control">
            </div>
            <div class="form-group">
              <label class="form-label" for="newvalue">{!! trans('dotenv-editor::views.addnew_label_value') !!}</label>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <form method="post" action="{{ url(config('dotenveditor.route.prefix') . "/upload") }}" enctype="multipart/form-data">
        <div class="form-group">
          <label class="form-label" for="backup">{!! trans('dotenv-editor::views.upload_label') !!}</label>

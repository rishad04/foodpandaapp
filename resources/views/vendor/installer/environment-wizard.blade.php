...
@section('container')
    <div class="tabs tabs-full">
        ...
        <label class="form-label" for="tab1" class="tab-label">
        ...
        <label class="form-label" for="tab2" class="tab-label">
        ...
        <label class="form-label" for="tab3" class="tab-label">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}">
                    ...
                    <label class="form-label" for="app_debug_true">
                    ...
                    <label class="form-label" for="app_debug_false">
                ...
                <div class="form-group {{ $errors->has('app_log_level') ? ' has-error ' : '' }}">
                    <label class="form-label" for="app_log_level">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_connection">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_hostname">
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_port">
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_name">
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_username">
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    <label class="form-label" for="database_password">
            ...
            <div class="tab" id="tab3content">
                <div class="block">
                    ...
                    <label class="form-label" for="appSettingsTab1">
                        <span>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('broadcast_driver') ? ' has-error ' : '' }}">
                            <label class="form-label" for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                        ...
                        <div class="form-group {{ $errors->has('cache_driver') ? ' has-error ' : '' }}">
                            <label class="form-label" for="cache_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.cache_label') }}
                                <sup>
                        ...
                        <div class="form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                            <label class="form-label" for="session_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.session_label') }}
                                <sup>
                        ...
                        <div class="form-group {{ $errors->has('queue_driver') ? ' has-error ' : '' }}">
                            <label class="form-label" for="queue_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.queue_label') }}
                                <sup>
                ...
                <div class="block">
                    ...
                    <label class="form-label" for="appSettingsTab2">
                        <span>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('redis_hostname') ? ' has-error ' : '' }}">
                            <label class="form-label" for="redis_hostname">
                        ...
                        <div class="form-group {{ $errors->has('redis_password') ? ' has-error ' : '' }}">
                            <label class="form-label" for="redis_password">{{ trans('installer_messages.environment.wizard.form.app_tabs.redis_password') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('redis_port') ? ' has-error ' : '' }}">
                            <label class="form-label" for="redis_port">{{ trans('installer_messages.environment.wizard.form.app_tabs.redis_port') }}</label>
                ...
                <div class="block">
                    ...
                    <label class="form-label" for="appSettingsTab3">
                        <span>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_driver">
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_host">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_host_label') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_port">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_port_label') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_username">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_username_label') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_password">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_password_label') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            <label class="form-label" for="mail_encryption">{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_encryption_label') }}</label>
                ...
                <div class="block margin-bottom-2">
                    ...
                    <label class="form-label" for="appSettingsTab4">
                        <span>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('pusher_app_id') ? ' has-error ' : '' }}">
                            <label class="form-label" for="pusher_app_id">
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_key') ? ' has-error ' : '' }}">
                            <label class="form-label" for="pusher_app_key">{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_key_label') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_secret') ? ' has-error ' : '' }}">
                            <label class="form-label" for="pusher_app_secret">{{ trans('installer_messages.environment.wizard.form.app_tabs.pusher_app_secret_label') }}</label>
